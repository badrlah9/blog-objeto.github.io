...
<div class="container">
  ...
  <form action="update.php?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">    
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control" id="modelo" name="modelo" rows="3" required><?php echo $articulo->getModelo();?></textarea>
    </div>

    <div class="mb-3">
      <label for="destacado" class="form-label">destacado</label>
      <textarea class="form-control" id="destacado" name="destacado" rows="3" required><?php echo $articulo->getDestacado();?></textarea>
    </div>
